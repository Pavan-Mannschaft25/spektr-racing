...
// //                     <motion.button
// //                       key="search-icon"
// //                       className="relative p-2 text-white border-2 border-blue-500 rounded-full hover:bg-blue-500/20 transition-all"
// //                       whileHover={{ scale: 1.1 }}
// //                       whileTap={{ scale: 0.9 }}
// //                       onClick={(e) => {
// //                         e.stopPropagation();
...
// //                         placeholder="Search..."
// //                         className="w-48 px-4 py-2 bg-white/10 border border-blue-500 rounded-full text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white/20 transition-all"
// //                         onBlur={() => {
// //                           if (!searchQuery) {
...
// //               <div className="relative">
// //                 <motion.button
// //                   className="relative p-2 w-10 h-10 flex items-center justify-center text-white bg-transparent border-2 border-blue-500 rounded-full hover:bg-blue-500/20 transition-all font-bold"
// //                   whileHover={{ scale: 1.1 }}
// //                   whileTap={{ scale: 0.9 }}
// //                   onClick={(e) => {
// //                     e.stopPropagation();
...
// //                   {isProfileOpen && (
// //                     <motion.div
// //                       className="absolute right-0 top-full mt-2 w-56 bg-white rounded-lg shadow-xl z-50 overflow-hidden"
...
// //                           className="w-full px-6 py-3 text-left text-red-500 hover:bg-gray-100 transition-colors font-medium"
// //                         >
// //                           Profile
// //                         </button>
// //                         <button
...
// //                           className="w-full px-6 py-3 text-left text-red-500 hover:bg-gray-100 transition-colors font-medium flex items-center gap-2"
// //                         >
// //                           <FiLogOut size={16} />
// //                           Logout
// //                         </button>
...
//   // ✅ FIXED: Click outside handler - won't close search/profile when clicking inside them
//   useEffect(() => {
//     const handleClickOutside = (event) => {
//       // Don't close if clicking inside search area
...
//   // ✅ FIXED: Logout now navigates to /login page
//   const handleLogout = () => {
//     // Clear user data / tokens here
...
//   // ✅ FIXED: Close search only when cancel button clicked
...
//               {/* ✅ FIXED: Search with Input Box - Only closes with X button */}
//               <div
...
//                       {/* ✅ FIXED: Logout Button - Navigates to /login */}
//                       <div className="border-t border-gray-200 py-2">
//                         <button
//                           onClick={handleLogout}
//                           className="w-full px-6 py-3 text-left text-red-500 hover:bg-gray-100 transition-colors font-medium flex items-center gap-2"
...
//                       {/* ✅ FIXED: Mobile Logout also goes to /login */}
//                       <motion.button
//                         onClick={handleLogout}
//                         className="w-full flex items-center justify-between p-4 text-red-500 font-extralight rounded-lg hover:bg-red-600/20 transition-all duration-300 group uppercase mt-4 border border-red-600/30"
//                       >
