...
// //                             animate={{ opacity: 1, scale: 1 }}
// //                             transition={{ delay: 0.5, type: "spring" }}
// //                             className="absolute -top-4 -right-4 bg-gradient-to-r from-red-500 to-red-700 text-white px-4 py-2 rounded-xl font-bold shadow-xl flex items-center gap-2"
// //                           >
// //                             NEW
// //                           </motion.div>
// //                         </motion.div>
...
//                       <Product3D key={isFullscreen ? "full" : "normal"} />
//                     </div>
//                   </div>
...
const ProductModal = ({ product, onClose }) => {
  ...
  // Detect mobile device for specific UI tweaks (like icon sizes)
  const [isMobile, setIsMobile] = useState(false);
  ...
  // Auto-fullscreen logic (optional, kept from your snippet)
  useEffect(() => {
    const timer = setTimeout(() => {
      setIsFullscreen(true);
    }, 500);
        ...
        >
          ...
          <div className="relative font-sans h-full pt-16 sm:pt-20">
            {/* 
               ...
               - Mobile/Tablet (default): flex-col (stacked)
            ...
            */}
            <div className="flex flex-col lg:flex-row h-full">
                ...
                >
                  <div className="w-full h-full flex items-center justify-center">
                    ...
                    <div className="w-full h-full lg:h-[70vh] flex items-center justify-center">
                      ...
                      <Product3D
                        model={product.model}
                        key={`${product.id}-${isFullscreen ? "full" : "normal"}`}
                      />
                    </div>
                  </div>
              ...
              {/* --- Right Side: Product Info --- */}
              {/* Mobile: flex-1 (fills rest of screen), scrollable. Desktop: fixed width. */}
              <motion.div
                initial={{ x: 400, opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
                transition={{ type: "spring", stiffness: 300, damping: 30 }}
