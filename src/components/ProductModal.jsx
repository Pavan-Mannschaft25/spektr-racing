...
//   MdLocalShipping,
// } from "react-icons/md";
// import { FaGem, FaAward, FaTruck } from "react-icons/fa";
...
//           }}
//           className={`relative w-full ${
//             isFullscreen ? "h-full max-w-full" : "max-w-[1600px] mx-4"
//           } bg-black/50 backdrop-blur-2xl overflow-hidden rounded-3xl shadow-2xl border border-white/10`}
//         >
//           {/* Shimmer Effect */}
//           <motion.div
...
//                 className="flex items-center gap-2 bg-black/40 backdrop-blur-xl px-4 py-2 rounded-2xl border border-white/10"
//               >
//                 <IoDiamond className="text-red-500" size={20} />
//                 <span className="text-white font-semibold">
//                   Premium Collection
//                 </span>
//               </motion.div>
...
//                             src={currentImages[currentImageIndex]}
//                             onLoad={() => setImageLoaded(true)}
//                             className={`max-w-full max-h-[65vh] lg:max-h-[70vh] object-contain rounded-3xl shadow-2xl transition-opacity duration-500 ${
//                               imageLoaded ? "opacity-100" : "opacity-0"
//                             }`}
//                             style={{
//                               filter:
//                                 "drop-shadow(0 25px 50px rgba(255, 0, 0, 0.3))",
//                             }}
//                             initial={{ opacity: 0, scale: 0.8, y: 50 }}
//                             animate={{ opacity: 1, scale: 1, y: 0 }}
//                             exit={{ opacity: 0, scale: 0.8, y: -50 }}
...
//                             animate={{ opacity: 1, scale: 1 }}
//                             transition={{ delay: 0.5, type: "spring" }}
//                             className="absolute -top-4 -right-4 bg-gradient-to-r from-red-500 to-red-700 text-white px-4 py-2 rounded-2xl font-bold shadow-xl flex items-center gap-2"
//                           >
//                             <FaGem size={16} />
//                             NEW
//                           </motion.div>
...
//                             transition={{ duration: 0.6, ease: "easeOut" }}
//                           />
//                           <div className="absolute inset-0 rounded-3xl bg-gradient-to-t from-red-600/20 to-transparent pointer-events-none" />
//                         </motion.div>
//                         <div className="absolute bottom-8 left-1/2 -translate-x-1/2 text-white text-center">
//                           <h3 className="text-2xl font-bold mb-2">360° View</h3>
//                           <p className="text-sm opacity-80">
...
//                               <motion.div
//                                 layoutId="activeThumbnail"
//                                 className="absolute inset-0 ring-2 ring-red-400 rounded-2xl"
//                               />
//                             )}
//                           </motion.button>
//                         );
...
//                       whileTap={{ scale: 0.9 }}
//                       onClick={prevImage}
//                       className="absolute left-8 top-1/2 -translate-y-1/2 p-4 bg-gradient-to-r from-red-600/80 to-red-800/80 backdrop-blur-xl rounded-3xl text-white shadow-2xl border border-white/20 hover:shadow-red-500/50 transition-all"
//                     >
//                       <IoChevronBack size={20} />
//                     </motion.button>
//                     <motion.button
...
//                       whileTap={{ scale: 0.9 }}
//                       onClick={nextImage}
//                       className="absolute right-8 top-1/2 -translate-y-1/2 p-4 bg-gradient-to-r from-red-600/80 to-red-800/80 backdrop-blur-xl rounded-3xl text-white shadow-2xl border border-white/20 hover:shadow-red-500/50 transition-all"
//                     >
//                       <IoChevronForward size={20} />
//                     </motion.button>
//                   </>
...
//                 animate={{ x: 0, opacity: 1 }}
//                 transition={{ type: "spring", stiffness: 300, damping: 30 }}
//                 className="w-full lg:max-w-[480px] xl:max-w-[520px] bg-gradient-to-b from-gray-900/95 to-black/95 backdrop-blur-2xl border-l border-white/10 p-8 xl:p-10 overflow-y-auto"
//               >
//                 <div className="space-y-8">
//                   {/* Product Title Section */}
//                   <div className="space-y-4">
...
//                       className="flex items-center gap-3"
//                     >
//                       <span className="px-4 py-2 bg-gradient-to-r from-red-600 to-red-800 text-white text-sm font-bold rounded-xl uppercase shadow-lg">
//                         Limited Edition
//                       </span>
...
//                           fill="currentColor"
//                         />
//                         <span className="text-red-400 font-bold">4.9</span>
//                         <span className="text-gray-300 text-sm">
//                           (324 reviews)
//                         </span>
//                       </div>
...
//                         initial={{ opacity: 0, x: -20 }}
//                         animate={{ opacity: 1, x: 0 }}
//                         className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-red-600"
//                       >
//                         ${product.price || "299"}
//                       </motion.span>
//                       {product.originalPrice && (
...
//                     </div>
//                     <div className="flex items-center gap-2 mt-3">
//                       <MdVerified className="text-red-400" size={20} />
...
//                     <div className="space-y-3">
//                       <div className="flex items-center gap-4 p-3 bg-gray-800/30 rounded-xl border border-gray-700/30">
//                         <FaTruck className="text-red-400" size={24} />
//                         <div>
//                           <p className="text-white font-semibold">
//                             Free Express Delivery
//                           </p>
...
//                       </div>
//                       <div className="flex items-center gap-4 p-3 bg-gray-800/30 rounded-xl border border-gray-700/30">
//                         <IoShieldCheckmark className="text-red-400" size={24} />
//                         <div>
//                           <p className="text-white font-semibold">
//                             2 Year Premium Warranty
//                           </p>
...
//                       </div>
//                       <div className="flex items-center gap-4 p-3 bg-gray-800/30 rounded-xl border border-gray-700/30">
//                         <MdRefresh className="text-red-400" size={24} />
//                         <div>
//                           <p className="text-white font-semibold">
//                             30-Day Hassle-Free Returns
//                           </p>
...
//                       </div>
//                       <div className="flex items-center gap-4 p-3 bg-gray-800/30 rounded-xl border border-gray-700/30">
//                         <IoGift className="text-red-400" size={24} />
//                         <div>
//                           <p className="text-white font-semibold">
//                             Premium Packaging
//                           </p>
...
//                     whileTap={{ scale: 0.98 }}
//                     onClick={handleAddToCart}
//                     className="w-full py-5 bg-gradient-to-r from-red-600 to-red-800 text-white rounded-2xl font-bold text-xl flex items-center justify-center gap-3 shadow-2xl hover:shadow-red-500/50 transition-all"
//                   >
//                     <IoCart size={28} />
//                     Add to Cart
//                   </motion.button> */}
...
//                     whileTap={{ scale: 0.98 }}
//                     onClick={handleAddToCart}
//                     className="w-full py-5 bg-gradient-to-r from-red-600 to-red-800 text-white rounded-2xl font-bold text-lg flex items-center justify-center gap-3 shadow-2xl hover:shadow-gray-500/50 transition-all border border-white/20"
//                   >
//                     <IoFlash size={28} />
//                     Buy Now
//                   </motion.button>
...
//                         animate={{ opacity: 1, y: 0 }}
//                         exit={{ opacity: 0, y: 20 }}
//                         className="absolute bottom-8 left-1/2 -translate-x-1/2 bg-red-500 text-white px-8 py-4 rounded-2xl font-bold text-lg shadow-2xl flex items-center gap-3"
//                       >
//                         <IoCheckmarkCircle size={24} />
//                         Added to Cart Successfully!
//                       </motion.div>
    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          ...
          className={`relative w-full h-full ${
            isFullscreen
              ...
              : "max-w-7xl mx-2 sm:mx-4 md:mx-6 lg:mx-8"
          } bg-black/90 backdrop-blur-2xl overflow-hidden ${
            isMobile ? "rounded-none" : "rounded-2xl sm:rounded-3xl"
        ...
        >
          ...
          {/* Header */}
          <div className="absolute top-0 left-0 right-0 z-50 p-3 sm:p-4 md:p-6 flex justify-between items-center">
            <div className="flex items-center gap-2 sm:gap-4">
              <motion.div
                initial={{ opacity: 0, x: -20 }}
                animate={{ opacity: 1, x: 0 }}
                className="flex items-center gap-1 sm:gap-2 bg-black/40 backdrop-blur-xl px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 rounded-xl sm:rounded-2xl border border-white/10"
              >
                <IoDiamond className="text-red-500" size={isMobile ? 16 : 20} />
          ...
          >
            ...
            >
              ...
              <div className="relative flex-1 flex items-center justify-center">
                ...
                >
                  <div
                    className={`flex gap-1 sm:gap-2 bg-black/60 backdrop-blur-2xl p-1 sm:p-1.5 rounded-2xl sm:rounded-3xl border border-white/20 shadow-2xl`}
                  >
                    {[
                      {
                        id: "gallery",
                      ...
                      <motion.button
                        ...
                        className={`relative px-2 sm:px-3 md:px-5 py-2 sm:py-3 rounded-xl sm:rounded-2xl flex items-center gap-1 sm:gap-2 text-xs sm:text-sm font-semibold transition-all overflow-hidden ${
                          viewMode === id
                            ? "text-white"
                            : "text-gray-400 hover:text-white"
                        }`}
                      ...
                      >
                        ...
                        >
                          {!imageLoaded && (
                            <div className="absolute inset-0 flex items-center justify-center">
                              <motion.div
                                ...
                                className={`w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 border-3 sm:border-4 border-red-500/30 border-t-red-500 rounded-full`}
                              />
                            </div>
                          )}
                          <motion.img
                            src={currentImages[currentImageIndex]}
                            onLoad={() => setImageLoaded(true)}
                            className={`max-w-full max-h-[40vh] sm:max-h-[50vh] md:max-h-[60vh] lg:max-h-[65vh] xl:max-h-[70vh] object-contain ${
                              isMobile
                                ? "rounded-xl"
                                : "rounded-2xl sm:rounded-3xl"
                            } shadow-2xl transition-opacity duration-500 ${
                              imageLoaded ? "opacity-100" : "opacity-0"
                            }`}
                            style={{
                              filter:
                          ...
                          <motion.div
                            ...
                            animate={{ opacity: 1, scale: 1 }}
                            transition={{ delay: 0.5, type: "spring" }}
                            className={`absolute -top-2 sm:-top-3 md:-top-4 -right-2 sm:-right-3 md:-right-4 bg-gradient-to-r from-red-500 to-red-700 text-white px-2 sm:px-3 md:px-4 py-1 sm:py-1.5 md:py-2 ${
                              isMobile
                                ? "rounded-lg"
                                : "rounded-xl sm:rounded-2xl"
                            } font-bold shadow-xl flex items-center gap-1 sm:gap-2 text-xs sm:text-sm`}
                          >
                            <FaGem size={isMobile ? 12 : 16} />
                            NEW
                          </motion.div>
                        </motion.div>
                      </motion.div>
                    ...
                    {viewMode === "magic" && (
                      ...
                      >
                        ...
                        >
                          <motion.img
                            src={currentImages[currentImageIndex]}
                            className="max-w-full max-h-[35vh] sm:max-h-[45vh] md:max-h-[55vh] lg:max-h-[60vh] object-contain rounded-2xl sm:rounded-3xl shadow-2xl"
                            initial={{ opacity: 0, scale: 0.8, y: 50 }}
                            animate={{ opacity: 1, scale: 1, y: 0 }}
                            exit={{ opacity: 0, scale: 0.8, y: -50 }}
                            transition={{ duration: 0.6, ease: "easeOut" }}
                          />
                          <div className="absolute inset-0 rounded-2xl sm:rounded-3xl bg-gradient-to-t from-red-600/20 to-transparent pointer-events-none" />
                        </motion.div>
                        <div className="absolute bottom-4 sm:bottom-6 md:bottom-8 left-1/2 -translate-x-1/2 text-white text-center px-4">
                ...
                {viewMode !== "magic" && (
                  <motion.div
                    ...
                    animate={{ y: 0, opacity: 1 }}
                    transition={{ delay: 0.3 }}
                    className="absolute bottom-4 sm:bottom-6 md:bottom-8 left-1/2 -translate-x-1/2 z-40"
                  >
                    <div
                      className={`flex gap-2 sm:gap-3 md:gap-4 px-3 sm:px-4 py-2 bg-black/60 backdrop-blur-2xl ${
                        isMobile ? "rounded-xl" : "rounded-2xl sm:rounded-3xl"
                        ...
                        return (
                          ...
                          >
                            <img
                              src={img}
                              alt=""
                              className={`w-10 h-8 sm:w-12 sm:h-10 md:w-14 md:h-12 object-contain bg-black/40`}
                            />
                            ...
                            {isActive && (
                              <motion.div
                                layoutId="activeThumbnail"
                                className="absolute inset-0 ring-2 ring-red-400 rounded-lg sm:rounded-xl"
                              />
                            )}
                          </motion.button>
                        );
                ...
                {viewMode !== "magic" && !isMobile && (
                  <>
                    <motion.button
                      ...
                      whileTap={{ scale: 0.9 }}
                      onClick={prevImage}
                      className="absolute left-4 sm:left-6 md:left-8 top-1/2 -translate-y-1/2 p-3 sm:p-4 bg-gradient-to-r from-red-600/80 to-red-800/80 backdrop-blur-xl rounded-2xl text-white shadow-2xl border border-white/20 hover:shadow-red-500/50 transition-all"
                    >
                      <IoChevronBack size={20} />
                    </motion.button>
                    <motion.button
                      ...
                      whileTap={{ scale: 0.9 }}
                      onClick={nextImage}
                      className="absolute right-4 sm:right-6 md:right-8 top-1/2 -translate-y-1/2 p-3 sm:p-4 bg-gradient-to-r from-red-600/80 to-red-800/80 backdrop-blur-xl rounded-2xl text-white shadow-2xl border border-white/20 hover:shadow-red-500/50 transition-all"
                    >
                      <IoChevronForward size={20} />
                    </motion.button>
                  </>
                ...
                {/* Controls */}
                <div className="absolute bottom-4 sm:bottom-6 md:bottom-8 right-4 sm:right-6 md:right-8 flex gap-2 sm:gap-3 z-40">
                  <motion.button
                    whileHover={{ scale: 1.1 }}
                    whileTap={{ scale: 0.9 }}
                    onClick={() => setIsFullscreen((p) => !p)}
                    className="p-2 sm:p-3 md:p-4 bg-black/70 backdrop-blur-xl rounded-xl sm:rounded-2xl text-gray-400 hover:text-white transition-all shadow-2xl border border-white/20"
                    title={isFullscreen ? "Exit Fullscreen" : "Fullscreen"}
                  >
                    {isFullscreen ? (
                      <MdFullscreenExit size={isMobile ? 20 : 24} />
                    ) : (
              ...
              <motion.div
                ...
                transition={{ type: "spring", stiffness: 300, damping: 30 }}
                className={`w-full ${
                  isMobile ? "max-w-full" : "lg:max-w-[480px] xl:max-w-[520px]"
              ...
              >
                <div className="space-y-4 sm:space-y-6 md:space-y-8 font-sans">
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    ...
                    {/* Quantity Selection */}
                    <div>
                      <p className="text-white font-semibold mb-2 sm:mb-3 text-base sm:text-lg">
                        Quantity
                      </p>
